            ...
            <div className="w-1/3">
                ...
                <div className="flex flex-col my-8">
                    <div className="flex gap-x-52">
                        ...
                        <label htmlFor="cvc" className="text-black font-semibold font-mono">CVC</label>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <input type="text" name="yy" className="bg-white border-2 border-gray-400 rounded-lg p-2 w-32 mr-8 text-black focus:border-purple-700 focus:outline-none" placeholder="YY"/>
                        <input type="text" name="cvc" className="bg-white border-2 border-gray-400 rounded-lg p-2 ml-12 w-44 text-black focus:border-purple-700 focus:outline-none" placeholder="e.g. 123"/>
                    </div>
                </div>
